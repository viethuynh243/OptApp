...
> **Mã:** OA-DOC-09 · **Phiên bản:** 1.1 · **Cập nhật:** 2026-06-29 · **Trạng thái:** Approved · **Căn cứ:** ui/ (v1.10.0)


> Tài liệu dành cho **người dùng** (kỹ sư thiết kế). Nếu cần hiểu thuật toán/kiến
> trúc bên trong, xem [Kiến trúc](../reference/ARCHITECTURE.md) / [Phương pháp](../reference/METHODOLOGY.md).
