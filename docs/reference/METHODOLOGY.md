...
> **Mã:** OA-DOC-03 · **Phiên bản:** 1.1 · **Cập nhật:** 2026-06-29 · **Trạng thái:** Approved · **Căn cứ:** core/, tests/validate_mcoc.py
...
với `cx, cy` là tâm nhóm cọc, `Ix = Σ(yᵢ−cy)²`, `Iy = Σ(xᵢ−cx)²` (xem [`rigid_cap.pile_forces`](../../core/rigid_cap.py)); tương đương dạng `Nⱼ = N/n ± Mx·yⱼ/Σyᵢ² ± My·xⱼ/Σxᵢ²` của tiêu chuẩn. **Ký hiệu** (TCVN 10304:2014): `[Po] ↔ Rc,d` (sức chịu tải trọng nén), `[Ct] ↔ Rt,d` (sức chịu tải trọng kéo), `Pmax/Pmin ↔ Nc,d/Nt,d` (tải trọng nén/kéo lên cọc).
