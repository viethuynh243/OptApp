...
| `core/cap_design.py` | Thiết kế đài — **uỷ quyền theo `DESIGN_BASIS`**: TCVN 11823-5:2017 (cầu) hoặc TCVN 5574:2018 (chỉ basis 10304, đối chiếu) |
| `core/cap_design_lrfd.py` | **Thiết kế đài bê tông cầu TCVN 11823-5:2017 (LRFD)** — uốn φMn, cắt φVn, chọc thủng 2 phương, STM. TCVN 5574 KHÔNG dùng cho cầu |
