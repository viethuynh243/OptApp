...
> (bệ 6.0 × 9.6 m, cọc khoan nhồi Ø1.2 m, [Po] = 500 T). Mục đích: minh họa
> một bản tính đủ thông tin để kỹ sư thẩm tra ký duyệt.
...
| Phần mềm | OptApp v… (kiểm chứng đối chiếu MCOC) |
...
> Đơn vị: lực **kN**, momen **kN·m**. ¹Tên tổ hợp do người dùng đặt theo trạng thái giới hạn.
...
buộc với hệ số sử dụng lớn nhất 0.974. Tiết kiệm so với các phương án nhiều cọc hơn.
...
- **Lực ngang Hx, Hy** và **momen xoắn Mz** (mô hình bỏ qua, dù input có nhập) →
